<div class="bg-white rounded-2xl shadow-md p-6 col-span-6">
    ...
    <div class="flex flex-col gap-5">
        <div class="flex flex-row bg-gray-100 rounded-xl p-5 items-center">
            <p class="w-1/2 text-base font-semibold">合計年間売上</p>
            <p class="w-1/2 text-2xl text-right">{{ number_format($salesSummaries->sum('total_amount')) }}<span class="text-sm ml-2">円</span></p>
        </div>
