<div class="bg-white rounded-2xl shadow-md p-6 col-start-1 col-span-6">
    ...
    <div class="grid grid-cols-2 gap-5">
        <div>
            <p class="text-sm"><i class="las la-map-marked-alt la-lg mr-1"></i>住所</p>
        ...
        <div>
            <p class="text-sm"><i class="las la-phone la-lg mr-1"></i>電話番号</p>
            <p class="ml-3">{{ $client->client_tel ?? '未登録' }}</p>
        </div>
        <div>
            <p class="text-sm"><i class="las la-link la-lg mr-1"></i>HP</p>
            <p class="ml-3">
