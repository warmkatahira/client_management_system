        ...
        <table class="text-xs">
            ...
            <tbody class="bg-white">
                @foreach($clients as $client)
                    <tr class="group text-left cursor-default whitespace-nowrap @if($client->client_status_id != ClientStatusEnum::ACTIVE) bg-gray-300 @endif">
                        ...
                        <td class="py-1 px-2 border sticky left-0 z-[40] {{ $client->client_status_id == ClientStatusEnum::ACTIVE ? 'bg-white' : 'bg-gray-300' }} group-hover:bg-slate-200">
