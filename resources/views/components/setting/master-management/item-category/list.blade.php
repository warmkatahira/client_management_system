                    ...
                    <tr class="text-left cursor-default whitespace-nowrap">
                        <td class="py-1 px-2 border">
                            <div class="flex flex-row gap-5">
                                <button type="button" class="btn toggle_components_btn bg-btn-enter text-white py-1 px-2"><i class="las la-plus"></i></button>
                            ...
                            <table class="w-full text-xs border-t border-gray-300">
                                <thead>
                                    <tr class="text-left bg-gray-300">
                                        <th class="font-thin py-1 px-2 border border-black text-center">取扱品目名(小)</th>
                                        <th class="font-thin py-1 px-2 border border-black text-center">並び順</th>
                                        <th class="font-thin py-1 px-2 border border-black text-center">最終更新</th>
                                    </tr>
                                </thead>
                                <tbody class="">
                                    @foreach($item_category->item_sub_categories as $item_sub_category)
                                        <tr>
                                            <td class="py-1 px-2 border border-black">{{ $item_sub_category->item_sub_category_name }}</td>
